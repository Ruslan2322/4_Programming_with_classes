...
public class MainBank {
    ...
    public static void main(String[] args) {
        ...
        randomBank.addNewClient(yakushev);
        randomBank.addNewClient(shulc);
...
//        lock check
        System.out.println(randomBank.getClient("ENB7654_76").getAccount(1).getStatus());
        randomBank.getClient("ENB7654_76").blockAccaunt(1);
        System.out.println(randomBank.getClient("ENB7654_76").getAccount(1).getStatus() + "\n");
//
//        //sorting check
        System.out.println(randomBank.getClient("ENB7654_76").getInformation());
        randomBank.getClient("ENB7654_76").sortByBalance();
        System.out.println(randomBank.getClient("ENB7654_76").getInformation());
        randomBank.getClient("ENB7644_89").sortByBalance();
        System.out.println(randomBank.getClient("ENB7644_89").getInformation());
